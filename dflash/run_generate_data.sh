...
# Usage: ./run_generate_data.sh [num_chunks] [output_dir] [target_layers] [stride] [block_sizes]
# Example: ./run_generate_data.sh 400 /data/dflash_train "24,30,31,32,34" 1 "8,16"
...
STRIDE="${4:-1}"
BLOCK_SIZES="${5:-8,16}"  # Support multiple: "8,16" or single: "16"
NUM_GPUS=8
